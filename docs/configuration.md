...
<table>
    <tr>
        ...
        <td colspan="2">
            ...
            P1 is the lowest-cost default for latency-focused LAN streaming. Increase this only when quality is
            bitrate-constrained and measurement shows the added encoder cost is acceptable.
